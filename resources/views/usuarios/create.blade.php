...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">{{ trans('Nuevo Usuario') }}</h4>
            ...
            <form action="{{ route('usuarios.store') }}" method="POST">
                ...
                <button type="submit" class="btn btn-principal">{{ trans('Guardar Usuario') }}</button>
                <a href="{{ route('usuarios.index') }}" class="btn btn-secundario">{{ trans('Cancelar') }}</a>
            </form>
        </div>
    </div>
